<?php 
	...
	if(isset($_GET['recherche'])){
		...
		$publication = [];
		$sql = "SELECT * FROM publication INNER JOIN diponibilitepub ON publication.id_pub=diponibilitepub.idPubDispo WHERE publication.titre_pub LIKE '%$recherche%' OR publication.titre_pub LIKE '$recherche%' OR publication.titre_pub LIKE '%$recherche%' OR publication.desc_pub LIKE '%$recherche%' OR publication.desc_pub LIKE '$recherche%' OR publication.desc_pub LIKE '%$recherche%' ORDER BY publication.id_pub DESC";
